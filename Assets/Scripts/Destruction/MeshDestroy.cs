...
public class MeshDestroy : MonoBehaviour
{
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            rigidbody.mass = original.GetComponent<Rigidbody>().mass / 1.5f;

            var meshDestroy = GameObject.AddComponent<MeshDestroy>();
            meshDestroy.CutCascades = (int)Mathf.Ceil((float)original.CutCascades/1.5f);
            meshDestroy.ExplodeForce = (int)Mathf.Ceil((float)original.ExplodeForce/1);
