...
public class RocketLauncher : Addon
{
    ...
    public override void Activate()
    {
        Instantiate(Resources.Load("Prefabs/Rocket"), Camera.main.transform.position + Camera.main.transform.forward, Quaternion.LookRotation(Camera.main.transform.forward));
    }
}
